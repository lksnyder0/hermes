# SandTrap Phase 1 - Research Findings
...
**SandTrap connects to proxy instead of socket**:
```python
# Instead of:
client = docker.from_env()
...
- Reduces attack surface if SandTrap is compromised
